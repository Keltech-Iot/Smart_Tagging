...
class HomeController extends Controller
{
    ...
    public function index(){
       ...
       $spliced2odf = count($panFib);

       $DarkFib = $totFibre - $spliced -  $spliced2odf;
       ...
       $spliced = $spliced + $spliced2odf;

       return view('home', ['panStat'=>$panStat, 'DarkFib'=>$DarkFib, 'spliced'=>$spliced, 'cabType'=>$cabType, 'cloType'=>$cloType,
       'totpan'=>$totPanels, 'totclo'=>$totClos, 'totFib'=>$totFibre, 'WP'=>$WP, 'du'=>$du, 'quad'=>$quad]);
   }
}
