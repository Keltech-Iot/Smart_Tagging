        ...
        @foreach($Data as $row)
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><a href="{{route('digi_viewImg', ['loc'=>$Spliceloc])}}" class="author" align="center"><img src="images/QA_trays/{{$row->tray_pic_loc}}"></a></td>
                </tr>
                <tr>
                    <th width="10%"><strong>Completed Job Photo</strong></th>
                    <td><a href="{{route('digi_viewImg', ['loc'=>$Comploc])}}" class="author"><img src="images/QA_trays/{{$row->com_pic_loc}}"></a></td>
                </tr>
                <tr>
