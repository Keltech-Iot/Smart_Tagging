...
<article class="post">
    ...
    <form method="POST" action="digi_store_cable" class="forms-sample">
        @csrf
        ...
        <input type="text" name="jID" placeholder="Junction ID" class="form-control">
        @error('jID')
        <div>{{$message}}</div>
        @enderror
        <br/>
        <label style="color:#f01111">Upstream Information</label>
        <input type="text" name="upData" placeholder="Upstream Information" class="form-control">
        @error('upData')
        <div>{{$message}}</div>
        @enderror
        <br/>
        <label style="color:#11f02f">Downstream Information</label>
        <input type="text" name="downData" placeholder="Downstream Information" class="form-control">
        @error('downData')
        <div>{{$message}}</div>
        @enderror
        <br/>
