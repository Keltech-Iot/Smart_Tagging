...
<!-- Header -->
	...
	<article class="post">
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th width="20%"><strong>Cable ID</strong></th>
                    <th width="10%"><strong>Fibre Size</strong></th>
                    <th width="10%"><strong>Function</strong></th>
                </tr>
            </thead>
            <tbody>
                @foreach($cables as $row)
                <tr>
                    <td><a href="digi_search_cable/{{$row->cable_id}}"> {{$row->cable_id}}</a></td>
