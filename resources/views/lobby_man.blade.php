...
<div id="main">
    <article class="post">
        <header>
            <div class="title">
                <h2>Manholes: <br/> <a style="color:#3754e6">{{$man->manhole_id}}</a></h2>
                <h4>Digital ID: {{$man->digi_id}}</h4>
            </div>
            <div class="meta">
                <div id="map"></div>
            </div>
    ...
    <article class="post">
        ...
        <header>
            ...
            <div align="center"><a href="cables/{{$man->manhole_id}}" class="button">View Cables</a></div><br/>
        </article>
        <article class="post">
           <header align="center">
...
function drawChart2() {
  ...
  var options = {'title':'Cable Status In {{$man->manhole_id}} ', 'width':750, 'height':400};
...
function initMap() {
    ...
    var lattitude = <?php echo json_encode($man->lat); ?>;
    var longitude = <?php echo json_encode($man->long); ?>;
