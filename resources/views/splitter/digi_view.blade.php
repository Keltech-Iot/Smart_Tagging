...
<!-- Header -->
    ...
    <div id="main">
        <article class="post">
        <header>
            <h2>{{$spl->splitter_name}}</h2>
            <h4>Work Point: {{$spl->wp_name}}</h4>
        </header>
        <table class="table">
            <tr>
                <th>Type</th>
            ...
            <tr>
                <th>Main Exchange</th>
                <td>{{$spl->main_exchange}}</td>
            </tr>
            <tr>
                <th>Fixation Point</th>
                <td>{{$spl->fixation_point}}</td>
            </tr>
        </table>
        <div align="center"><a href="{{route('digi_edit_splitter', ['splitter'=>$spl->splitter_name])}}" class="button">Edit</a></div>
        </article>
    </div>
