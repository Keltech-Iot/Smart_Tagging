	...
	<article class="post">
        <header>
            ...
            <form method="POST" action="work_order_store" class="forms-sample">
              ...
              <input type="text" name="projID" value="{{$proj_id}}" class="form-control" readonly>
              @error('projID')
              <div>{{$message}}</div>
              @enderror
              <br/>
              ...
              <input type="text" name="proID" placeholder="Product Name" class="form-control">
              @error('proID')
              <div>{{$message}}</div>
              @enderror
              <br/>
